...
const EmailHenBaoDuong = (giatri) => {
    ...
    const mailOptions = {
        ...
        <h2 style="text-align: center; text-transform: uppercase;color:
            rgb(240, 82, 47); font-style: italic; font-weight: 400;">Thông báo đến hẹn bảo dưỡng xe</h2>
        <div style="padding-left: 20px; padding-right: 20px;">
            ...
            <div style=" height: auto; padding-top:
              ...
              <div style="border-radius:4px;padding:14px 24px 15px 24px;text-align:left;font-family:inherit;width:350px;margin:auto;font-style:italic;font-weight:400;flex-direction: column;">
                    <span style="padding-bottom: 5px;line-height:20px; display: block; margin-top: 10px;"><span>Xin chào ${giatri.nhanxung === 1 ? "Anh" : "Chị"} </span><span>${giatri.name}</span></span>
                    ...
                    <span style="padding-bottom: 5px;line-height:20px; display: block; margin-top: 10px;">Với mẫu loại xe <spadn style="color: red;">${giatri.IdLoaiXe.name}</span></span>
...
module.exports = EmailHenBaoDuong