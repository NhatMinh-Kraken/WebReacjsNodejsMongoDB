...
const EmailChoKhachHangBaoDuong = (giatri) => {
    ...
    <div style="max-width: 700px; margin:auto; border: 1px solid #f0f0f0;
        ...
        <h2 style="text-align: center; text-transform: uppercase;color:
            rgb(240, 82, 47); font-style: italic; font-weight: 400;">Bảo dưỡng hoàn thành</h2>
        <div style="padding-left: 20px; padding-right: 20px;">
            ...
            <div style=" height: auto; padding-top:
              ...
              <div style="border-radius:4px;padding:14px 24px 15px 24px;text-align:left;font-family:inherit;width:350px;margin:auto;font-style:italic;font-weight:400;flex-direction: column;">
                    <span style="padding-bottom: 5px;line-height:20px; display: block; margin-top: 10px;"><span>Xin chào ${giatri.nhanxung === 1 ? "Anh" : "Chị"} ${giatri.name} </span></span>
                    <span style="padding-bottom: 5px;line-height:20px; display: block; margin-top: 10px; color: green">Đơn hàng bảo dưỡng của bạn đã hoàn thành, kính mời quý khách đến nhận xe.</span>
              </div>
            </div>
...
module.exports = EmailChoKhachHangBaoDuong