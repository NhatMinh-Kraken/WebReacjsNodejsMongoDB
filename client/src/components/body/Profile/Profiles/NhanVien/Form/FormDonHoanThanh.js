...
function FormDonHoanThanh({ sum, donDatLichUser, handleCloseHT, optionBuoc1, optionBuoc2, showHT, ClickDonHangHT, DonHoanThanh, QuyTrinhBaoDuong, garage, logo }) {
    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Footer>
                    <Button variant="primary" onClick={handleCloseHT}>Đóng</Button>
                </Modal.Footer>
            </Modal>
