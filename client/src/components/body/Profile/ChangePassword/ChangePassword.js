                            ...
                            <div className='form-body d-flex col-12'>
                                <div className="form col-12">
                                    ...
                                    <div className="input-group col-10">
                                        ...
                                        <input type="password" className="form-controls col-10" name="oldPassword" id="oldPassword" placeholder="..." onChange={handleChangeInput} />
                                    </div>
                                </div>
                            </div>
                            <div className='form-body d-flex col-12 pt-3'>
                                <div className="form col-12">
                                    ...
                                    <div className="input-group col-10">
                                        ...
                                        <input type="password" className="form-controls col-10" name="password" id="password" placeholder="..." onChange={handleChangeInput} />
                                    </div>
                                </div>
                            </div>
                            <div className='form-body d-flex col-12 pt-3'>
                                <div className="form col-12">
                                    ...
                                    <div className="input-group col-10">
                                        ...
                                        <input type="password" className="form-controls col-10" name="cf_password" id="cf_password" placeholder="..." onChange={handleChangeInput} />
                                    </div>
                                </div>
                            </div>
                        </div>
